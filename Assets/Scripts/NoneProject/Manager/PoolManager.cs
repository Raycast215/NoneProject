...
namespace NoneProject.Manager
{
    public class PoolManager : SingletonBase<PoolManager>
    {
        ...
        {
            await UniTask.WaitUntil(() => AddressableManager.Instance.isInitialized);
            
             AddressableManager.Instance.LoadAsset<ProjectilePool>(ProjectileKey, result => Load(out projectilePool, result, _projectileHolder)).Forget();
        }
